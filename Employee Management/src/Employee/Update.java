...
{
    JFrame jf;
    JLabel lblimage,lbltitle,lblname,lblfname,lblempid,lbladdress,lblphone,lblemail,lbledu,lbljobpost,lblaadhar;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==bupdate && k==1){
            try{
                Databaseconn c = new Databaseconn();
                String str = "update employee_details set Name='"+tname.getText()+"',Fathername='"+tfname.getText()+"',Age='"+age+"',DOB='"+dob+"',Address='"+taddress.getText()+"',Phone='"+tphone.getText()+"',EmailID='"+temail.getText()+"',Education='"+tedu.getText()+"',JobPost='"+tjobpost.getText()+"',AadharNo='"+taadhar.getText()+"',EmployeeID='"+tempid.getText()+"' where EmployeeID='"+empid+"'";
