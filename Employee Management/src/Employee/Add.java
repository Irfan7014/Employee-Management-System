    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==submit)
        {
            try
            {
                ...
                String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,q;
                s1=t1.getText();
                s2=t2.getText();
                s3=t3.getText();
                s4=t4.getText();
                ...
                q="insert into employee_details (EmployeeID,Name,FatherName,Age,DOB,Address,Phone,EmailID,Education,JobPost,AadharNo) values ('"+s11+"',"+"'"+s1+"',"+"'"+s2+"',"+"'"+s3+"',"+"'"+s4+"',"+"'"+s5+"',"+"'"+s6+"',"+"'"+s7+"',"+"'"+s8+"',"+"'"+s9+"',"+"'"+s10+"')";
                c.s.executeUpdate(q);
